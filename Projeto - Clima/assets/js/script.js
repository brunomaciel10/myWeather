...
function showInfo(json) {
    ...
    document.querySelector(".temp--atual").innerHTML = `${json.temp.toFixed(1)}°c`; // temperatura atual
    document.querySelector(".temp--min--max").innerHTML = `${json.tempMin.toFixed(1)}°c / ${json.tempMax.toFixed(1)}°c ` // mínima e máxima
    ...
    document.querySelector(".sencTermica").innerHTML = `${json.sencTermica.toFixed(1)}°c`; // sensação térmica
